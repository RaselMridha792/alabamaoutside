...
export const PRACTICE_AREAS = {
  personal: {
    title: "Personal",
    description: "Our civil attorneys can help, whether your case involves a business dispute, a wrongful death, whether you were in a car wreck, or you are a whistleblower, you need a lawyer to protect your best interests.",
    items: [
      "Civil Lawsuits",
      "Criminal Defense",
      "Divorce & Family Law",
  ...
  professional: {
    title: "Professional",
    description: "We have years of experience representing both plaintiffs and defendants in business litigation and regulatory representation. We have the skills and expertise to get you the best possible outcome to your dispute.",
    items: [
      "Administrative Law",
...
export const FEATURED_REPORTERS = [
...
export const OFFICE_INFO = [
  {
    ...
    addressLine1: "1929 3rd Ave. North, Suite 500",
...
export const ATTORNEYS = [
  { name: "Jeffrey E. Holmes", role: "Partner / Litigator" },
  { name: "William C. White, II", role: "Partner / White Collar Defense" },
  { name: "H. Hampton Boles", role: "Partner / Corporate Law" },
  { name: "Nathan Holmes", role: "Attorney / Business Law" },
  { name: "Suzanne Norman", role: "Attorney / Personal & Family Law" }
];

export const DISCLAIMERS = {
  barDisclaimer: "no representation is made that the quality of the legal services to be performed is greater than the quality of legal services performed by other lawyers.",
  copyright: "© 2024 Boles Holmes White LLC"
};

export const CONTACT_PAGE_IMAGE = "https://alabamaoutsidecounsel.com/wp-content/uploads/2024/06/5fbc0a0c0b0ea380e7229577_courtroom-898931_1920-1-1.jpg";

export const SMS_CONSENT_TEXT = "By providing your phone number, you consent to receive automated informational/promotional SMS communications from Lawmatics on behalf of Boles Holmes White. Consent is not a condition of purchase. Message & data rates may apply and frequency will vary. Reply STOP to unsubscribe. Text HELP for help. Privacy Policy • Terms of Use";
...
export const BLOG_POSTS = [
  ...
  {
    id: 2,
    slug: "illegal-sports-gambling-subject-to-prosecution",
    title: "Illegal Sports Gambling Subject to Prosecution",
    imageUrl: "https://alabamaoutsidecounsel.com/wp-content/uploads/2024/06/6020ee12b5fd30cf76f29cc0_book-1.jpg.webp",
    heroImage: "https://alabamaoutsidecounsel.com/wp-content/uploads/2024/06/about-cover.jpg",
    content: `
      <p>In years past, sports gambling was often associated with seedy characters involved in organized crime where weekly settlements occurred in person, and could involve violence for failure to pay a gambling debt. There was also a concern this type of violent behavior could influence the outcome of sporting events. As a result, a number of laws were enacted in the 1950s and aggressive prosecutions arose to shut down this activity.</p>
      <p>In spite of these laws and prosecutions, sports wagering has not disappeared. In fact, it has grown as an industry with more and more states legalizing it under their regulatory authority.</p>
      <p>Despite this widespread acceptance of sports betting, there are still criminal prosecutions that arise from sports gambling. The vast majority of these prosecutions involve individuals operating gambling businesses outside the scope of regulation of their local authority. If you are not a regulated gambling entity, you almost certainly would be considered to be involved in criminal activity. The primary avenues the government utilizes in prosecuting these cases are through the charges of tax evasion, wire fraud and money laundering.</p>
      <h3>Illegal Sports Gambling and Tax Evasion</h3>
      <p><strong>Tax Evasion</strong> – Tax laws for regulated and legally operated gambling businesses are complicated. This is not the typical source of a gambling tax evasion investigation. Usually, criminal tax evasion cases involving gambling involve the “bookie” or owner of an unregistered gambling operation failing to claim taxes on his gambling profits. Such failure to list these profits on tax returns can result in arrest for tax evasion. This is the most common form of criminal prosecution in a gambling case.</p>
      <h3>Wire Fraud</h3>
      <p><strong>Wire Fraud</strong> – The “Wire Act” criminalizes the use of the internet, phone or fax lines, and other forms of wire transfers to conduct any illegal gambling operation. In other words, if you are operating a gambling business in a state where sports betting is illegal (even if only a misdemeanor) you can be guilty of felony wire fraud if payment or wagering is made using the internet or other wire. In our modern society, it is likely that all gambling operations involve the use of federal wires in some manner to implicate the Wire Act.</p>
      <h3>Money Laundering</h3>
      <p><strong>Money Laundering</strong> – Finally, prosecutors also often bring “money laundering” charges against illegal gambling operations. Federal money laundering statutes make it a crime try to legitimize illegally obtained funds in an effort to hide the criminal source of those funds. In other words, it is illegal to take dirty money and try to clean it through a legitimate business or transaction. It is also common for the government to seek forfeiture of laundered proceeds. In other words, the government will seize all of the money laundered and request the Court Order the funds be forfeited entirely to the government.</p>
      <p>If you are under investigation for involvement in illegal sports gambling, or have in questions in Alabama about this topic, call the sports gambling attorneys at Boles Holmes White LLC for legal assistance.</p>
    `
  },
  {
    id: 3,
    slug: "wally-walker-assists-in-securing-settlement",
