...
// আপনার তৈরি করা কম্পোনেন্টগুলো ইমপোর্ট করা হলো
...
export default function ArsonPage() {
  ...
  return (
    <div className="bg-slate-50 min-h-screen text-gray-800 scroll-smooth pb-16" id="arson-page">
      {/* Hero Section */}
          ...
          <section className="lg:col-span-7 space-y-12" id="personal-content-col">
            ...
            <div className="space-y-4">
              ...
              <h3 className="font-serif text-lg sm:text-xl text-brand-gold font-semibold italic border-l-4 border-brand-navy pl-4" id="personal_subheading_2">
                Experienced Alabama Arson Attorneys Protecting Your Interests
              </h3>
            </div>
            ...
            <div className="bg-white p-6 sm:p-8 rounded-lg shadow-md border border-gray-100 relative overflow-hidden" id="general-inquiry-card">
              ...
              <p className="font-sans text-sm sm:text-base text-gray-700 leading-relaxed text-justify mb-4">
                Our Arson attorneys are used to putting out fires. The arson criminal defense lawyers in Alabama at Boles Holmes White LLC have extensive experience in investigating and defending arson cases in Birmingham and throughout Alabama.
              </p>
            ...
            <div className="space-y-4" id="arson-degrees-section">
              ...
              <div className="bg-white p-6 sm:p-8 rounded-lg border border-gray-150 shadow-sm leading-relaxed">
                ...
                {/* Arson Degrees Blocks */}
                <div className="mt-6 space-y-4">
                  <div className="p-4 bg-slate-50 border-l-4 border-brand-gold rounded-r">
                    <h4 className="text-xs sm:text-sm font-bold text-brand-navy uppercase tracking-wide">Arson First Degree</h4>
                    <p className="text-xs sm:text-sm text-gray-600 mt-2 text-justify">
                  ...
                  <div className="p-4 bg-slate-50 border-l-4 border-brand-gold rounded-r">
                    <h4 className="text-xs sm:text-sm font-bold text-brand-navy uppercase tracking-wide">Arson Second Degree</h4>
                    <p className="text-xs sm:text-sm text-gray-600 mt-2 text-justify">
                  ...
                  <div className="p-4 bg-slate-50 border-l-4 border-brand-gold rounded-r">
                    <h4 className="text-xs sm:text-sm font-bold text-brand-navy uppercase tracking-wide">Arson Third Degree</h4>
                    <p className="text-xs sm:text-sm text-gray-600 mt-2 text-justify">
                ...
                <div className="mt-8 pt-6 border-t border-gray-100">
                  <p className="font-sans text-sm sm:text-base text-brand-navy text-justify font-semibold">
                    Our fire defense attorneys Alabama stand ready to offer you a free consultation on your arson case, or any other criminal charge. Call the Alabama arson attorneys at Boles Holmes White LLC today at 205-502-2000.
                  </p>
                </div>
                  ...
                  <div className="space-y-1.5">
                    ...
                    <div className="relative font-semibold">
                      ...
                      >
                        ...
                        <option value="Criminal Defense">Criminal Defense (Arson)</option>
