          ...
          <section className="lg:col-span-7 space-y-12" id="personal-content-col">
            ...
            <div className="bg-white p-6 sm:p-8 rounded-lg shadow-md border border-gray-100 relative overflow-hidden" id="general-inquiry-card">
              ...
              <p className="font-sans text-sm sm:text-base text-gray-700 leading-relaxed text-justify mb-4">
                With a rich tradition of excellence in criminal defense, the alabama dui defense attorneys of Boles Holmes White LLC are known for their stunning victories in high-profile cases of national interest. However, our office maintains a tight focus on felony and misdemeanor DUI defense throughout the state of Alabama.
              </p>
              
              <p className="font-sans text-sm sm:text-base text-gray-700 leading-relaxed text-justify">
                Our concentration on DUI and DWI charges means that our clients benefit from focused, sophisticated and confident representation in a friendly and attentive atmosphere. If you’re thinking about saving money by pleading guilty without a defense attorney, you might want to think again. First of all, you could have strong defenses ranging from an improper traffic stop to unreliable toxicology reports that few people would recognize. There might also be pretrial diversion programs in the community where you were arrested that could sidestep the criminal justice system altogether.
              </p>
            </div>

            {/* Segment 1: DWI Law Firm serving clients */}
            <div className="space-y-4" id="dwi-law-firm-section">
              ...
              <div className="bg-white p-6 sm:p-8 rounded-lg border border-gray-150 shadow-sm leading-relaxed">
                <p className="font-sans text-sm sm:text-base text-gray-750 text-justify mb-5">
                  An experienced Alabama Dui Defense attorney at Boles Holmes White LLC can evaluate your situation and find a way to protect you from the consequences of a drunk driving conviction. When you consider that even a first offense can cost you several thousand dollars in court costs, fines, increased insurance premiums, chemical dependency treatment and license reinstatement fees, you’ll find that our single flat fee for your defense might turn out to be a great investment.
                </p>

                <p className="font-sans text-sm sm:text-base text-gray-750 text-justify mb-5">
                  Our DWI and DUI defense attorneys are all accomplished trial lawyers who know how to find the weaknesses in a DUI case and apply them to the benefit of our clients. We handle misdemeanor DUI defense, repeat DUI or DUI felonies, tourist or commercial driver arrests, and driver’s license suspension hearings. You will get personal attention from your first consultation until your case is settled. They can advise you about your DUI &amp; DWI defense options in a free initial consultation.
                </p>
                ...
                <div className="p-5 bg-slate-50 border-t border-gray-100 rounded">
                  <p className="font-sans text-sm sm:text-base text-brand-navy font-semibold text-justify">
                    Contact Our skilled Alabama Dui Defense Attorney at Boles Holmes White LLC as soon as possible after your arrest to get your defense organized and under way.
                  </p>
                </div>
              </div>
            </div>
