...
export default function ProfessionalPage({ onNavigateToContact }) {
  ...
  // Media logos corresponding to the screenshot layout
  const mediaLogos = [
    ...
    <div className="bg-slate-50 min-h-screen text-gray-800 scroll-smooth pb-16" id="professional-administrative-page">
      ...
      <section className="bg-white py-16 sm:py-20 px-4 sm:px-6 lg:px-8 border-y border-gray-100" id="professional-media-section">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-6 sm:gap-8 items-center justify-items-center select-none" id="prof-media-grid">
            {mediaLogos.map((reporter, index) => (
              <motion.div
                ...
                id={`prof_media_item_${reporter.name.toLowerCase().replace(/[^a-z0-9]/g, '_')}`}
              >
